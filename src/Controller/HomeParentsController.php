...
{
    #[Route('/home/parents/{i}', name: 'app_home_parents', defaults: ['i' => 0])]

    public function index(EntityManagerInterface $entityManager, Request $request, $i): Response
    {
        $user = $this->getUser();
